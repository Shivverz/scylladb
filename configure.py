...
# user_cflags += ' -I/usr/local/opentelemetry-shared/include'
...
def configure_seastar(build_dir, mode, mode_config):
    ...
    seastar_cmake_args = [
        ...
        # '-DCMAKE_PREFIX_PATH=/usr/local/opentelemetry-shared',
    ]
...
# libs += ' -L/usr/local/opentelemetry-shared/lib -lopentelemetry_proto -lopentelemetry_trace'
